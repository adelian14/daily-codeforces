...
for _ in range(t):
    ...
    a = helper.read_line()
    b = helper.read_line()
    a1 = [x for i,x in enumerate(a) if i%2==0]
    a2 = [x for i,x in enumerate(a) if i%2==1]
    b1 = [x for i,x in enumerate(b) if i%2==0]
    b2 = [x for i,x in enumerate(b) if i%2==1]
    if b1.count('1') == a1.count('1') and b2.count('1')==a2.count('1'):
        print("YES")
    else:
        print("NO")